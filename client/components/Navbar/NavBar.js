    ...
    return (
        <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div className="relative flex items-center justify-between">
                ...
                <ul className="flex items-center hidden space-x-8 lg:flex text-xl text-gray-900 text-semibold">
                    <li>
                        <Link href=''>Home</Link>
                    </li>
                    <li>
                ...
                <ul className="flex items-center hidden space-x-8 lg:flex">
                    ...
                    <li>
                        <a href="#_" className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-pink-700 rounded-xl group">
                            ...
                            <span className="relative w-full text-left text-white text-xl transition-colors duration-200 ease-in-out group-hover:text-white">Sign up</span>
                        </a>
                    </li>
                </ul>
                    ...
                    {isMenuOpen && (
                        <div className="absolute top-0 left-0 w-full">
                            <div className="p-5 bg-white border rounded shadow-sm">
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        <a
                                            ...
                                            className="inline-flex items-center"
                                        >
                                            <Image src='/assets/images/logo3.png' height={50} width={50} alt='logo'></Image>
                                ...
                                <nav>
                                    <ul className="space-y-4 text-xl text-gray-900 text-semibold">
                                        <li>
                                            <Link href=''>Home</Link>
                                        </li>
                                        <li>
